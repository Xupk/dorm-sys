<@dwz.layout_content>
<@dwz.form action="${request.contextPath}/management/security/violation/create" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<@dwz.layout_form_content layoutH="58">
		...
		<@dwz.label_input content="记录人:">
			<input type="text" name="manager" class="" size="20" maxlength="20"/>
		</@dwz.label_input>	

...
public interface ViolationService {
	...
	Violation get(String roomName);
	
	List<Violation> find(Page page, String roomName);

	void update(Violation violation);

	void save(Violation violation) throws ExistedException;

	Violation get(Long id);

	void delete(Long id) throws ServiceException;

	List<Violation> findAll(Page page);
